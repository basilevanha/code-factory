...
const BlocContactNF = ({
  ...
  const outValue =
    inValue === 1 && capteurValue === 0
      ? 1
      : inValue === 0 || capteurValue === 1
        ? 0
        : undefined;
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <span
          className={clsx(
            ...
            // Inverse la valeur : 1 devient 0, 0 devient 1, undefined reste undefined
            getColorByValue(
              capteurValue === 1 ? 0 : capteurValue === 0 ? 1 : capteurValue
            )
          )}
        >
          --|/|--
